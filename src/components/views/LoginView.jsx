          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                value={identifier}
                onChange={(e) => setIdentifier(isAdminMode ? e.target.value : e.target.value.toLowerCase())}
                className={`w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-900 border border-slate-700 text-sm text-white focus:outline-none focus:border-purple-500 transition-colors ${isAdminMode ? '' : 'lowercase'}`}
              />
            </div>
            {!isAdminMode && (
